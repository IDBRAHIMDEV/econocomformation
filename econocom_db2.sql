...
-- Export de la structure de la table econocomdb. fos_user
...
-- Export de données de la table econocomdb.fos_user : ~2 rows (environ)
/*!40000 ALTER TABLE `fos_user` DISABLE KEYS */;
INSERT INTO `fos_user` (`id`, `username`, `username_canonical`, `email`, `email_canonical`, `enabled`, `salt`, `password`, `last_login`, `confirmation_token`, `password_requested_at`, `roles`) VALUES
	(1, 'idbrahim', 'idbrahim', 'idbrahimdev@gmail.com', 'idbrahimdev@gmail.com', 1, NULL, '$2y$13$MEbsR5eu0YuDCCek85Xdu.X.Xyb4LWIaI4cD4Ax/ZVkYp4S12OyLu', '2017-12-28 15:34:16', NULL, NULL, 'a:2:{i:0;s:10:"ROLE_ADMIN";i:1;s:16:"ROLE_SUPER_ADMIN";}'),
	(3, 'walid', 'walid', 'walid@gmail.com', 'walid@gmail.com', 1, NULL, '$2y$13$V0rQNVllIP0ibG0G7le8..ocsZLkLieq6QFfrTHoe0z77c0TJ56q2', '2017-12-28 15:33:18', NULL, NULL, 'a:0:{}');
...
-- Export de données de la table econocomdb.image : ~29 rows (environ)
...
INSERT INTO `image` (`id`, `alt`, `url`) VALUES
	...
	(30, 'edffrg', 'IMG20171011101153.jpg');
/*!40000 ALTER TABLE `image` ENABLE KEYS */;

-- Export de la structure de la table econocomdb. page
...
-- Export de données de la table econocomdb.page : ~1 rows (environ)
/*!40000 ALTER TABLE `page` DISABLE KEYS */;
INSERT INTO `page` (`id`, `title`, `description`, `body`) VALUES
	(1, 'page 1', 'page module des pages', 'zkejfjefjefj');
...
-- Export de données de la table econocomdb.post : ~32 rows (environ)
...
INSERT INTO `post` (`id`, `title`, `content`, `datepublication`, `category_id`, `active`, `image_id`) VALUES
	...
	(32, 'dfdfdfdf', 'efefefef', '2021-10-19', 1, 1, 30);
...
-- Export de données de la table econocomdb.post_tag : ~120 rows (environ)
