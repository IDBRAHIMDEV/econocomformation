...
namespace Proxies\__CG__\PostBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Post extends \PostBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PostBundle\\Entity\\Post' . "\0" . 'id', '' . "\0" . 'PostBundle\\Entity\\Post' . "\0" . 'title', '' . "\0" . 'PostBundle\\Entity\\Post' . "\0" . 'content', '' . "\0" . 'PostBundle\\Entity\\Post' . "\0" . 'datePublication', '' . "\0" . 'PostBundle\\Entity\\Post' . "\0" . 'category', '' . "\0" . 'PostBundle\\Entity\\Post' . "\0" . 'tags', '' . "\0" . 'PostBundle\\Entity\\Post' . "\0" . 'active', '' . "\0" . 'PostBundle\\Entity\\Post' . "\0" . 'image'];
        }
