 ...
 */
class Tag extends \PostBundle\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PostBundle\\Entity\\Tag' . "\0" . 'id', '' . "\0" . 'PostBundle\\Entity\\Tag' . "\0" . 'title', '' . "\0" . 'PostBundle\\Entity\\Tag' . "\0" . 'active', '' . "\0" . 'PostBundle\\Entity\\Tag' . "\0" . 'posts'];
        }
